            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.statsContainer}>
                    ...
                    <View style={styles.statsBox}>
                        ...
                        <Text style={[styles.text, styles.subText]}>Disponibilité</Text>
                    </View>
                </View>
                ...
                <View style={{ alignItems: "center" }}>
                    <View style={styles.recentItem}>
                        ...
                        <View style={{ width: 250 }}>
                            <Text style={[styles.text, { color: "#41444B", fontWeight: "300" }]}>
                                Diplomé d'Etat <Text style={{ fontWeight: "400" }}>En Churgie</Text> à <Text style={{ fontWeight: "400" }}>L'Institut de Tunis</Text>
                            </Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.recentItem}>
                        ...
                        <View style={{ width: 250 }}>
                            <Text style={[styles.text, { color: "#41444B", fontWeight: "300" }]}>
                            Réalisation des soins et prothèses dentaires  <Text style={{ fontWeight: "400" }}>en collaboration avec les prothésiste</Text>
                            </Text>
                        </View>
                    </View>
                    <View style={styles.recentItem}>
